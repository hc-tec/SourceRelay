...
if (CORE_RELEASE_VERSION !== '0.7.17' || CORE_SERVICE_SCHEMA_VERSION !== 3 || listDirectCapabilities().length !== 18) throw new Error('js_sdk_release_probe_failed');
