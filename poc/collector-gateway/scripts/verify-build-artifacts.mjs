...
const source = await readFile(resolve(root, 'dist', 'server.js'), 'utf8');
...
assert.equal(
  ...
  true,
  'Gateway package must depend on the Browser Host client package'
);
