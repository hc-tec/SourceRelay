...
export const COLLECTION_SERIES_OBSERVER_BINDING_STORAGE_PREFIX =
  'collector.collection-series-observer.' as const;
export const COLLECTION_SERIES_DETAIL_OBSERVER_BINDING_STORAGE_PREFIX =
  'collector.collection-series-detail-observer.' as const;
